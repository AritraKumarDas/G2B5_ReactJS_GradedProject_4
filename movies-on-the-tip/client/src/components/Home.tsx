...
const Home = (props: Props) => {
    ...
    useEffect(() => {
        ...
        const helper = async () => {
            ...
            try {
                const response = await fetchAllMovies('movies-in-theaters');
                setMovies(response)
        ...
        <>
            ...
            <Container>
                ...
                {status === loadingStatus.error && (
                    <Row>
                        <Col>
                            <AlertPage variant="danger" text="Error encountered while loading page">
...

                {
                    status === loadingStatus.loaded && !error && filteredMovies.length > 0 && (
                        <>
                            <Row>
                                <Col><h3 className="my-2">All Movies</h3></Col>
                            </Row>
